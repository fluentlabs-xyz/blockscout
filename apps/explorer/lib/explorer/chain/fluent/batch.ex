defmodule Explorer.Chain.Fluent.Batch do
  @moduledoc """
    Models a batch for Fluent.

    Changes in the schema should be reflected in the bulk import module:
    - Explorer.Chain.Import.Runner.Fluent.Batches

    Migrations:
    - Explorer.Repo.Migrations.AddFluentBatchesTables
  """
  ...
  alias Explorer.Chain.Fluent.BatchBundle
  ...
  @typedoc """
    ...
    * `commit_block_number` - A block number of the commit transaction on L1.
    * `commit_timestamp` - A timestamp of the commit block.
    * `bundle_id` - An identifier of the batch bundle from the `fluent_batch_bundles` database table.
    * `l2_block_range` - A range of L2 blocks included into the batch. Can be `nil` if cannot be determined.
    * `container` - A container where the batch info is mostly located (can be :in_calldata, :in_blob4844).
  """
  @primary_key false
  typed_schema "fluent_batches" do
