defmodule Explorer.Chain.Fluent.BatchBundle do
  @moduledoc """
    Models a batch bundle for Fluent.

    Changes in the schema should be reflected in the bulk import module:
    - Explorer.Chain.Import.Runner.Fluent.BatchBundles
  ...
  typed_schema "fluent_batch_bundles" do
